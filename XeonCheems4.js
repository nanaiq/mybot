...
├ No Owner : https://wa.me/622150996855
...
├ Device Bot : Windows
└┬────────────❒
   │  My Group Bot : http://tiny.cc/X-ZC
   │  My Insta : http://tiny.cc/Nathalie 
   └─────────────❒`
...
mediaType:1,
mediaUrl: 'https://telegra.ph/file/c9b533c77ab023a07ce99.jpg',
sourceUrl: "https://telegra.ph/file/c9b533c77ab023a07ce99.jpg"
}}
}
XeonBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
XeonBotInc.sendMessage(from, { react: { text: `${global.reactmoji}`, key: m.key }})
	                let btn = [{
                        ...
                        let buttonmenu = [
        	{ urlButton: { displayText: `Istagram`, url : `${websitex}` } },
            { urlButton: { displayText: `Group Bot`, url: `${botscript}` } },
            { quickReplyButton: { displayText: `All Menu`, id: 'allmenu'} },
            { quickReplyButton: { displayText: `List Comand`, id: 'command'} },
...
├ ${prefix}request
├ ${prefix}report [bug]
╰❒` + '' + ' ', `${botname}`,unicorn, [{"urlButton": {"displayText": "Istagram","url": `${websitex}`}},{"urlButton": {"displayText": "Group Bot","url": `${botscript}`}},{"quickReplyButton": {"displayText": "Donate","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}}] )
break
case 'ownermenu':
	   if (isBan) return reply(mess.ban)
	if (isBanChat) return reply(mess.banChat)
